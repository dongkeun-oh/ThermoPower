    ...
    package LHe "Icons for component using water/steam as working fluid"
      ...
      partial model Tube
        ...
        annotation (Icon(graphics={Rectangle(
                ...
                lineColor={0,0,0},
                fillPattern=FillPattern.HorizontalCylinder,
                fillColor={0,128,255})}),                        Diagram(graphics));
      end Tube;
      ...
      partial model Mixer
        ...
        annotation (Icon(graphics={Ellipse(
                ...
                lineColor={0,0,0},
                fillPattern=FillPattern.Solid,
                fillColor={0,128,255}), Text(extent={{-100,-84},{100,-110}},
                  textString="%name")}), Diagram(graphics));
      end Mixer;
      ...
      partial model Accumulator
        ...
        annotation (Icon(graphics={
              Rectangle(lineColor = {0, 0, 255}, fillColor = {128, 128, 128}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-60, 80}, {60, -40}}),
              Ellipse(lineColor = {0, 0, 255}, fillColor = {128, 128, 128}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-60, 100}, {60, 60}}),
              Ellipse(lineColor = {0, 0, 255}, fillColor = {128, 128, 128}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-60, -20}, {60, -60}}),
              Ellipse(lineColor = {0, 0, 191}, fillColor = {159, 159, 223}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-52, 94}, {52, 64}}),
              Rectangle(lineColor = {0, 0, 191}, fillColor = {0, 128, 255}, fillPattern = FillPattern.Solid, extent = {{-52, 22}, {52, -40}}),
              Rectangle(lineColor = {0, 0, 255}, fillColor = {159, 159, 223}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-52, 80}, {52, 20}}),
              Ellipse(lineColor = {0, 0, 191}, fillColor = {0, 128, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-52, -24}, {52, -54}}),
              Rectangle(lineColor = {0, 0, 255}, fillColor = {128, 128, 128}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-4, -58}, {4, -86}}),
              Rectangle(lineColor = {0, 0, 255}, fillColor = {128, 128, 128}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-26, -86}, {26, -94}}),
              Text(extent={{-62,-100},{64,-122}}, textString="%name"),
              Polygon(lineColor = {0, 0, 255}, fillColor = {128, 128, 128}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, points = {{-74, 86}, {-60, 72}, {-54, 78}, {-68, 92}, {-74, 86}})}), Diagram(graphics));
      end Accumulator;
      ...
      partial model PumpMech
        ...
        annotation (Icon(graphics={
              Rectangle(fillColor = {160, 160, 164}, fillPattern = FillPattern.HorizontalCylinder, extent = {{54, 28}, {80, 12}}),
              Polygon(lineColor = {0, 0, 255}, fillColor = {0, 128, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, points = {{-40, -24}, {-60, -60}, {60, -60}, {40, -24}, {-40, -24}}),
              Ellipse(fillPattern = FillPattern.Sphere, extent = {{-60, 80}, {60, -40}}),
              Polygon(fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.HorizontalCylinder, points = {{-30, 52}, {-30, -8}, {48, 20}, {-30, 52}}),
              Text(extent={{-100,-64},{100,-90}}, textString="%name")}));
      end PumpMech;
    
      partial model PressDrop
    
        annotation (Icon(graphics={Rectangle(fillPattern = FillPattern.HorizontalCylinder, extent = {{-80, 40}, {80, -40}}), Polygon(fillColor = {0, 128, 255}, fillPattern = FillPattern.HorizontalCylinder, points = {{-80, 40}, {-42, 40}, {-20, 12}, {20, 12}, {40, 40}, {80, 40}, {80, -40}, {40, -40}, {20, -12}, {-20, -12}, {-40, -40}, {-80, -40}, {-80, 40}})}), Diagram(graphics));
      ...
      partial model SteamTurbineUnit
        ...
        annotation (Icon(graphics={
              Line(points = {{14, 20}, {14, 42}, {38, 42}, {38, 20}}, thickness = 0.5),
              Rectangle(fillColor = {160, 160, 164}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-100, 8}, {100, -8}}),
              Polygon(fillColor = {0, 128, 255}, fillPattern = FillPattern.Solid, lineThickness = 0.5, points = {{-14, 48}, {-14, -48}, {14, -20}, {14, 20}, {-14, 48}}),
              Polygon(fillColor = {0, 128, 255}, fillPattern = FillPattern.Solid, lineThickness = 0.5, points = {{38, 20}, {38, -20}, {66, -46}, {66, 48}, {38, 20}}),
              Polygon(fillColor = {0, 128, 255}, fillPattern = FillPattern.Solid, lineThickness = 0.5, points = {{-66, 20}, {-66, -20}, {-40, -44}, {-40, 48}, {-66, 20}}),
              Line(points = {{-100, 70}, {-100, 70}, {-66, 70}, {-66, 20}}, thickness = 0.5),
              Line(points = {{-40, 46}, {-40, 70}, {26, 70}, {26, 42}}, thickness = 0.5),
              Line(points = {{-14, -46}, {-14, -70}, {66, -70}, {66, -46}}, thickness = 0.5),
              Line(
                points={{66,-70},{100,-70}},
                color={0,0,255},
                thickness=0.5)}), Diagram(graphics));
      ...
      partial model Header
        ...
        annotation (Icon(graphics={
              Ellipse(lineColor = {95, 95, 95}, fillColor = {95, 95, 95}, fillPattern = FillPattern.Solid, extent = {{-80, 80}, {80, -80}}),
              Ellipse(lineColor = {95, 95, 95}, fillColor = {0, 128, 255}, fillPattern = FillPattern.Solid, extent = {{70, 70}, {-70, -70}}),
              Text(extent={{-100,-84},{100,-110}}, textString="%name")}), Diagram(
              graphics));
      end Header;
    end LHe;
